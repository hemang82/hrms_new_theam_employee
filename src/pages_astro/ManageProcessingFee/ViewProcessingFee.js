...
import { processingFeeAdd, processingFeeDetails, processingFeeUpdate, updateCategoryQuestion } from '../../utils/api.services';
    ...
    return (
        <>
            ...
            <div className="container-fluid mw-100">
                <SubNavbar title={processingFeeData ? 'Details Processing Fee' : 'Add Processing Fee'} header={'Processing Fee List'} subHeaderOnlyView={processingFeeData ? 'Details Processing Fee' : 'Add Processing Fee'} />
